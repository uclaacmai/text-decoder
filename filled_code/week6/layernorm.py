...
class LayerNorm(nn.Module):
    ...
    def forward(self, residual: Tensor) -> Tensor:
        ...
        # Normalize the residual by taking the difference between the residual and the mean,
        # and dividing by the square root of the variance, then multiply by the learned weight
        # and add the learned bias
